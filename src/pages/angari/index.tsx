        ...
        <AppContainer>
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                Изготовление и монтаж тентовых ангаров из ПВХ-ткани. Ангары
                любой конструкции и размеров, с учётом снеговой и ветровой
                нагрузки региона. Используем ПВХ-ткань плотностью 630–900 г/м²,
                сварку горячим воздухом, усиленные стропы и фурнитуру. Гарантия
                до 3 лет.
              </p>
            ...
            <AppGetPriceBanner
              title="Рассчитать стоимость тентового ангара"
              categoryKey="angari"
            />
