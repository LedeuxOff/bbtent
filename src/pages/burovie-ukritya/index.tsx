          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                ...
                900–1100 г/м² в г. Энгельс, Саратовская область. Укрытия для
                буровых вышек, установок и оборудования с возможностью быстрого
                монтажа и демонтажа. Используем утеплитель 50–100 мм,
                морозоустойчивую фурнитуру и сварку горячим воздухом. Работаем
                по чертежам заказчика или выполняем замеры на месте. Гарантия до
                3 лет. Доставка по всей России.
              </p>
            ...
            {/* ✅ Усиленный CTA с гео */}
            <AppGetPriceBanner
              title="Рассчитать стоимость бурового укрытия в Энгельсе"
              categoryKey="burovie-ukritya"
            />
