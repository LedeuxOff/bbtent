          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                ...
                плотностью 700–800 г/м² в г. Энгельс, Саратовская область.
                Подходят для беседок, веранд, балконов, террас и летних кафе.
                Материал устойчив к морозу до -30°C, УФ-излучению и механическим
                повреждениям. Используем профессиональную фурнитуру: молнии,
                липучки, люверсы. Гарантия до 2 лет. Доставка по всей России.
              </p>
            ...
            {/* ✅ Усиленный CTA с гео */}
            <AppGetPriceBanner
              title="Рассчитать стоимость мягких окон в Энгельсе"
              categoryKey="myagkie-okna"
            />
