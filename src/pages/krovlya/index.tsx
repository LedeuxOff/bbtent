        ...
        <AppContainer>
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                Выполняем монтаж и ремонт плоской кровли из ПВХ-мембраны.
                Работаем как с вашим материалом, так и предоставляем
                ПВХ-мембрану плотностью 1200–1500 г/м² от проверенных
                поставщиков. Используем профессиональное оборудование для
                термосварки, обеспечивая 100% герметичность швов. Подходим для
                крыш домов, ангаров, складов, гаражей и промышленных цехов.
                Гарантия на монтаж — до 10 лет.
              </p>
            ...
            {/* ✅ Усиленный CTA с гео */}
            <AppGetPriceBanner
              title="Рассчитать стоимость монтажа кровли"
              categoryKey="krovlya"
            />
