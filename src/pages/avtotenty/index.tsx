          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                ...
                (плотность 630–900 г/м²) в г. Энгельс, Саратовская область.
                Тенты на легковые авто, фуры, прицепы, спецтехнику и прицепы —
                по вашим чертежам или нашим замерам. Используем сварку горячим
                воздухом (прочнее сшивки), усиленные люверсы, стропы и ленты.
                Гарантия до 3 лет. Доставка по всей России.
              </p>
            ...
            {/* ✅ Усиленный CTA с гео */}
            <AppGetPriceBanner
              title="Рассчитать стоимость автотента в Энгельсе"
              categoryKey="auto"
            />
