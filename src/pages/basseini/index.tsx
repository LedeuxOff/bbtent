          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                ...
                стационарных бассейнов в г. Энгельс, Саратовская область.
                Используем ПВХ-ткань плотностью 800–900 г/м², устойчивую к УФ,
                хлору и морозу до -50°C. Делаем вкладыши по вашим размерам, а
                также крышки от пыли, листьев и мусора. Сварка горячим воздухом
                обеспечивает 100% герметичность. Гарантия до 3 лет. Доставка по
                всей России.
              </p>
            ...
            {/* ✅ Усиленный CTA с гео */}
            <AppGetPriceBanner
              title="Рассчитать стоимость вкладыша для бассейна в Энгельсе"
              categoryKey="basseini"
            />
