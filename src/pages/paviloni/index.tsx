          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                ...
                сварщика. Используем ПВХ-ткань плотностью 650–900 г/м²,
                прозрачные вставки (мягкие окна), москитные сетки и усиленную
                фурнитуру. Работаем по вашим чертежам или выполняем замеры на
                месте. Подходят для рынков, ярмарок, дач и уличной торговли.
                Гарантия до 3 лет.
              </p>
            ...
            {/* ✅ Усиленный CTA с гео */}
            <AppGetPriceBanner
              title="Рассчитать стоимость павильона"
              categoryKey="paviloni"
            />
