          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              >
                ...
                фундаментов и промышленных водоёмов в г. Энгельс, Саратовская
                область. Используем ПВХ-мембрану (1200–1500 г/м²), геомембрану,
                полипропилен (ПП) и полиэтилен (ПЭ). Все швы выполняем методом
                термосварки на профессиональном оборудовании, проводим проверку
                герметичности (вакуум, искровой тест). Гарантия на работу — до
                15 лет. Выезд по всей России.
              </p>
            ...
            {/* ✅ Усиленный CTA */}
            <AppGetPriceBanner
              title="Рассчитать стоимость гидроизоляции лагуны в Энгельсе"
              categoryKey="laguni"
            />
