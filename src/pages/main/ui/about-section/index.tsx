            ...
            <div className="grid grid-cols-4 flex-wrap gap-4">
              ...
              >
                ...
                <p className="text-[#000] text-[16px]">
                  ...
                  надёжно защищают от дождя, снега, ветра и УФ-излучения.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[#000] text-[16px]">
                  ...
                  надёжную защиту ваших объектов на территории России.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[#000] text-[16px]">
                  ...
                  вашим размерам, обеспечивая высокое качество и комфорт при
                  эксплуатации.
                </p>
              </div>
            </div>
